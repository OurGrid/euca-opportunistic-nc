...
/**
 * NcGetConsoleOutputResponseType.java
 *
 ...
 */
            ...
            /**
            *  NcGetConsoleOutputResponseType bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class NcGetConsoleOutputResponseType extends edu.ucsb.eucalyptus.EucalyptusMessage
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        /**
                        * field for ConsoleOutput
                        */

                        
                                    protected java.lang.String localConsoleOutput ;
                           ...
                           */
                           public  java.lang.String getConsoleOutput(){
                            ...
                            /**
                               ...
                               * @param param ConsoleOutput
                               */
                               public void setConsoleOutput(java.lang.String param){
                            
                                            this.localConsoleOutput=param;
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ncGetConsoleOutputResponseType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ncGetConsoleOutputResponseType",
                           xmlWriter);
                   }
                ...
                if (localCorrelationIdTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    namespace = "http://eucalyptus.ucsb.edu/";
                                    writeStartElement(null, namespace, "consoleOutput", xmlWriter);
                             

                                          if (localConsoleOutput==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("consoleOutput cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localConsoleOutput);
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://eucalyptus.ucsb.edu/","ncGetConsoleOutputResponseType"));
                 if (localCorrelationIdTracker){
                                 ...
                                 for (int i = 0;i < localNotreadyServices.length;i++){
                                    ...
                                    if (localNotreadyServices[i] != null){
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://eucalyptus.ucsb.edu/",
                                        ...
                                        if (localConsoleOutput != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localConsoleOutput));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("consoleOutput cannot be null!!");
                                        }
    ...
    public static class Factory{
        ...
        */
        public static NcGetConsoleOutputResponseType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            NcGetConsoleOutputResponseType object =
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ncGetConsoleOutputResponseType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (NcGetConsoleOutputResponseType)edu.ucsb.eucalyptus.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list8 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://eucalyptus.ucsb.edu/","consoleOutput").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"consoleOutput" +"  cannot be null");
                                    }
                                    

                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setConsoleOutput(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
