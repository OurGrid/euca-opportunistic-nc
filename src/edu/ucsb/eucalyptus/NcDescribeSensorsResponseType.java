...
/**
 * NcDescribeSensorsResponseType.java
 *
 ...
 */
            ...
            /**
            *  NcDescribeSensorsResponseType bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class NcDescribeSensorsResponseType extends edu.ucsb.eucalyptus.EucalyptusMessage
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = ncDescribeSensorsResponseType
                ...
                */
                        ...
                        /**
                        * field for SensorsResources
                        * This was an Array!
                        */

                        
                                    protected edu.ucsb.eucalyptus.SensorsResourceType[] localSensorsResources ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localSensorsResourcesTracker = false ;

                           public boolean isSensorsResourcesSpecified(){
                               return localSensorsResourcesTracker;
                           }
                           ...
                           * @return edu.ucsb.eucalyptus.SensorsResourceType[]
                           */
                           public  edu.ucsb.eucalyptus.SensorsResourceType[] getSensorsResources(){
                               return localSensorsResources;
                           }
                              ...
                              /**
                               * validate the array for SensorsResources
                               */
                              protected void validateSensorsResources(edu.ucsb.eucalyptus.SensorsResourceType[] param){
                              ...
                              * @param param SensorsResources
                              */
                              public void setSensorsResources(edu.ucsb.eucalyptus.SensorsResourceType[] param){
                              
                                   validateSensorsResources(param);

                               localSensorsResourcesTracker = param != null;
                                      
                                      this.localSensorsResources=param;
                              }
                             ...
                             * @param param edu.ucsb.eucalyptus.SensorsResourceType
                             */
                             public void addSensorsResources(edu.ucsb.eucalyptus.SensorsResourceType param){
                                   if (localSensorsResources == null){
                                   localSensorsResources = new edu.ucsb.eucalyptus.SensorsResourceType[]{};
                                   }

                            
                                 //update the setting tracker
                                localSensorsResourcesTracker = true;
                            

                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localSensorsResources);
                               list.add(param);
                               this.localSensorsResources =
                             (edu.ucsb.eucalyptus.SensorsResourceType[])list.toArray(
                            new edu.ucsb.eucalyptus.SensorsResourceType[list.size()]);
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ncDescribeSensorsResponseType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ncDescribeSensorsResponseType",
                           xmlWriter);
                   }
                ...
                if (localCorrelationIdTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localSensorsResourcesTracker){
                                       if (localSensorsResources!=null){
                                            for (int i = 0;i < localSensorsResources.length;i++){
                                                if (localSensorsResources[i] != null){
                                                 localSensorsResources[i].serialize(new javax.xml.namespace.QName("http://eucalyptus.ucsb.edu/","sensorsResources"),
                                                           xmlWriter);
                                                } else {
                                               ...
                                               throw new org.apache.axis2.databinding.ADBException("sensorsResources cannot be null!!");
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://eucalyptus.ucsb.edu/","ncDescribeSensorsResponseType"));
                 if (localCorrelationIdTracker){
                             ...
                             if (localSensorsResources!=null) {
                                 for (int i = 0;i < localSensorsResources.length;i++){
                                    ...
                                    if (localSensorsResources[i] != null){
                                         elementList.add(new javax.xml.namespace.QName("http://eucalyptus.ucsb.edu/",
                                                                          "sensorsResources"));
                                         elementList.add(localSensorsResources[i]);
                                    } else {
    ...
    public static class Factory{
        ...
        */
        public static NcDescribeSensorsResponseType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            NcDescribeSensorsResponseType object =
                new NcDescribeSensorsResponseType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ncDescribeSensorsResponseType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (NcDescribeSensorsResponseType)edu.ucsb.eucalyptus.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list10 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://eucalyptus.ucsb.edu/","sensorsResources").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list10.add(edu.ucsb.eucalyptus.SensorsResourceType.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone10){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://eucalyptus.ucsb.edu/","sensorsResources").equals(reader.getName())){
                                                                    list10.add(edu.ucsb.eucalyptus.SensorsResourceType.Factory.parse(reader));
                                                        ...
                                                        object.setSensorsResources((edu.ucsb.eucalyptus.SensorsResourceType[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                edu.ucsb.eucalyptus.SensorsResourceType.class,
                                                                list10));
