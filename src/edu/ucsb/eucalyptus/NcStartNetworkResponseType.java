...
/**
 * NcStartNetworkResponseType.java
 *
 ...
 */
            ...
            /**
            *  NcStartNetworkResponseType bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class NcStartNetworkResponseType extends edu.ucsb.eucalyptus.EucalyptusMessage
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        /**
                        * field for NetworkStatus
                        */

                        
                                    protected java.lang.String localNetworkStatus ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localNetworkStatusTracker = false ;

                           public boolean isNetworkStatusSpecified(){
                               return localNetworkStatusTracker;
                           }
                           ...
                           */
                           public  java.lang.String getNetworkStatus(){
                            ...
                            /**
                               ...
                               * @param param NetworkStatus
                               */
                               public void setNetworkStatus(java.lang.String param){
                            localNetworkStatusTracker = param != null;
                                   
                                            this.localNetworkStatus=param;
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ncStartNetworkResponseType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ncStartNetworkResponseType",
                           xmlWriter);
                   }
                ...
                if (localCorrelationIdTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localNetworkStatusTracker){
                                    namespace = "http://eucalyptus.ucsb.edu/";
                                    writeStartElement(null, namespace, "networkStatus", xmlWriter);
                             

                                          if (localNetworkStatus==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("networkStatus cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localNetworkStatus);
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://eucalyptus.ucsb.edu/","ncStartNetworkResponseType"));
                 if (localCorrelationIdTracker){
                                 ...
                                 for (int i = 0;i < localNotreadyServices.length;i++){
                                    ...
                                    if (localNotreadyServices[i] != null){
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://eucalyptus.ucsb.edu/",
                                        ...
                                        if (localNetworkStatus != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localNetworkStatus));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("networkStatus cannot be null!!");
                                        }
                                    }
    ...
    public static class Factory{
        ...
        */
        public static NcStartNetworkResponseType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            NcStartNetworkResponseType object =
                new NcStartNetworkResponseType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ncStartNetworkResponseType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (NcStartNetworkResponseType)edu.ucsb.eucalyptus.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list8 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://eucalyptus.ucsb.edu/","networkStatus").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"networkStatus" +"  cannot be null");
                                    }
                                    

                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setNetworkStatus(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
