...
/**
 * NcDescribeBundleTasksResponseType.java
 *
 ...
 */
            ...
            /**
            *  NcDescribeBundleTasksResponseType bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class NcDescribeBundleTasksResponseType extends edu.ucsb.eucalyptus.EucalyptusMessage
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = ncDescribeBundleTasksResponseType
                ...
                */
                        ...
                        /**
                        * field for BundleTasks
                        * This was an Array!
                        */

                        
                                    protected edu.ucsb.eucalyptus.BundleTaskType[] localBundleTasks ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localBundleTasksTracker = false ;

                           public boolean isBundleTasksSpecified(){
                               return localBundleTasksTracker;
                           }
                           ...
                           * @return edu.ucsb.eucalyptus.BundleTaskType[]
                           */
                           public  edu.ucsb.eucalyptus.BundleTaskType[] getBundleTasks(){
                               return localBundleTasks;
                           }
                              ...
                              /**
                               * validate the array for BundleTasks
                               */
                              protected void validateBundleTasks(edu.ucsb.eucalyptus.BundleTaskType[] param){
                              ...
                              * @param param BundleTasks
                              */
                              public void setBundleTasks(edu.ucsb.eucalyptus.BundleTaskType[] param){
                              
                                   validateBundleTasks(param);

                               localBundleTasksTracker = param != null;
                                      
                                      this.localBundleTasks=param;
                              }
                             ...
                             * @param param edu.ucsb.eucalyptus.BundleTaskType
                             */
                             public void addBundleTasks(edu.ucsb.eucalyptus.BundleTaskType param){
                                   if (localBundleTasks == null){
                                   localBundleTasks = new edu.ucsb.eucalyptus.BundleTaskType[]{};
                                   }

                            
                                 //update the setting tracker
                                localBundleTasksTracker = true;
                            

                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localBundleTasks);
                               list.add(param);
                               this.localBundleTasks =
                             (edu.ucsb.eucalyptus.BundleTaskType[])list.toArray(
                            new edu.ucsb.eucalyptus.BundleTaskType[list.size()]);
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ncDescribeBundleTasksResponseType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ncDescribeBundleTasksResponseType",
                           xmlWriter);
                   }
                ...
                if (localCorrelationIdTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localBundleTasksTracker){
                                       if (localBundleTasks!=null){
                                            for (int i = 0;i < localBundleTasks.length;i++){
                                                if (localBundleTasks[i] != null){
                                                 localBundleTasks[i].serialize(new javax.xml.namespace.QName("http://eucalyptus.ucsb.edu/","bundleTasks"),
                                                           xmlWriter);
                                                } else {
                                               ...
                                               throw new org.apache.axis2.databinding.ADBException("bundleTasks cannot be null!!");
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://eucalyptus.ucsb.edu/","ncDescribeBundleTasksResponseType"));
                 if (localCorrelationIdTracker){
                             ...
                             if (localBundleTasks!=null) {
                                 for (int i = 0;i < localBundleTasks.length;i++){
                                    ...
                                    if (localBundleTasks[i] != null){
                                         elementList.add(new javax.xml.namespace.QName("http://eucalyptus.ucsb.edu/",
                                                                          "bundleTasks"));
                                         elementList.add(localBundleTasks[i]);
                                    } else {
    ...
    public static class Factory{
        ...
        */
        public static NcDescribeBundleTasksResponseType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            NcDescribeBundleTasksResponseType object =
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ncDescribeBundleTasksResponseType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (NcDescribeBundleTasksResponseType)edu.ucsb.eucalyptus.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list10 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://eucalyptus.ucsb.edu/","bundleTasks").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list10.add(edu.ucsb.eucalyptus.BundleTaskType.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone10){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://eucalyptus.ucsb.edu/","bundleTasks").equals(reader.getName())){
                                                                    list10.add(edu.ucsb.eucalyptus.BundleTaskType.Factory.parse(reader));
                                                        ...
                                                        object.setBundleTasks((edu.ucsb.eucalyptus.BundleTaskType[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                edu.ucsb.eucalyptus.BundleTaskType.class,
                                                                list10));
