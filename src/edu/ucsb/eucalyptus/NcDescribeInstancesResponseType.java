...
/**
 * NcDescribeInstancesResponseType.java
 *
 ...
 */
            ...
            /**
            *  NcDescribeInstancesResponseType bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class NcDescribeInstancesResponseType extends edu.ucsb.eucalyptus.EucalyptusMessage
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                                    ...
                                    protected edu.ucsb.eucalyptus.InstanceType[] localInstances ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           * @return edu.ucsb.eucalyptus.InstanceType[]
                           */
                           public  edu.ucsb.eucalyptus.InstanceType[] getInstances(){
                               ...
                               */
                              protected void validateInstances(edu.ucsb.eucalyptus.InstanceType[] param){
                              ...
                              */
                              public void setInstances(edu.ucsb.eucalyptus.InstanceType[] param){
                             ...
                             * @param param edu.ucsb.eucalyptus.InstanceType
                             */
                             public void addInstances(edu.ucsb.eucalyptus.InstanceType param){
                                   if (localInstances == null){
                                   localInstances = new edu.ucsb.eucalyptus.InstanceType[]{};
                                   }
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localInstances);
                               list.add(param);
                               this.localInstances =
                             (edu.ucsb.eucalyptus.InstanceType[])list.toArray(
                            new edu.ucsb.eucalyptus.InstanceType[list.size()]);
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ncDescribeInstancesResponseType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ncDescribeInstancesResponseType",
                           xmlWriter);
                   }
                                       ...
                                       if (localInstances!=null){
                                            for (int i = 0;i < localInstances.length;i++){
                                                if (localInstances[i] != null){
                                                 localInstances[i].serialize(new javax.xml.namespace.QName("http://eucalyptus.ucsb.edu/","instances"),
                                                           xmlWriter);
                                                } else {
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://eucalyptus.ucsb.edu/","ncDescribeInstancesResponseType"));
                 if (localCorrelationIdTracker){
    ...
    public static class Factory{
        ...
        */
        public static NcDescribeInstancesResponseType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            NcDescribeInstancesResponseType object =
                new NcDescribeInstancesResponseType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ncDescribeInstancesResponseType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (NcDescribeInstancesResponseType)edu.ucsb.eucalyptus.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list10 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://eucalyptus.ucsb.edu/","instances").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list10.add(edu.ucsb.eucalyptus.InstanceType.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone10){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://eucalyptus.ucsb.edu/","instances").equals(reader.getName())){
                                                                    list10.add(edu.ucsb.eucalyptus.InstanceType.Factory.parse(reader));
                                                        ...
                                                        object.setInstances((edu.ucsb.eucalyptus.InstanceType[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                edu.ucsb.eucalyptus.InstanceType.class,
                                                                list10));
