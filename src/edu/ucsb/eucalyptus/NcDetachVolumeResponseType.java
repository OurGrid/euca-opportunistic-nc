...
/**
 * NcDetachVolumeResponseType.java
 *
 ...
 */
            ...
            /**
            *  NcDetachVolumeResponseType bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class NcDetachVolumeResponseType extends edu.ucsb.eucalyptus.EucalyptusMessage
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ncDetachVolumeResponseType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ncDetachVolumeResponseType",
                           xmlWriter);
                   }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://eucalyptus.ucsb.edu/","ncDetachVolumeResponseType"));
                 if (localCorrelationIdTracker){
    ...
    public static class Factory{
        ...
        */
        public static NcDetachVolumeResponseType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            NcDetachVolumeResponseType object =
                new NcDetachVolumeResponseType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ncDetachVolumeResponseType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (NcDetachVolumeResponseType)edu.ucsb.eucalyptus.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
