 ...
 */
            ...
            /**
            *  NcCancelBundleTaskType bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class NcCancelBundleTaskType extends edu.ucsb.eucalyptus.EucalyptusMessage
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = ncCancelBundleTaskType
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ncCancelBundleTaskType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ncCancelBundleTaskType",
                           xmlWriter);
                   }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://eucalyptus.ucsb.edu/","ncCancelBundleTaskType"));
                 if (localCorrelationIdTracker){
    ...
    public static class Factory{
        ...
        */
        public static NcCancelBundleTaskType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            NcCancelBundleTaskType object =
                new NcCancelBundleTaskType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ncCancelBundleTaskType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (NcCancelBundleTaskType)edu.ucsb.eucalyptus.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
